...
<body class="bg-gray-100 text-gray-900">
    <div class="min-h-screen flex flex-col">
        ...
        <footer class="bg-gray-300 shadow-md w-full border-t">
            <div
                class="max-w-screen-xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center">
                <div class="w-full sm:w-1/4 text-center sm:text-left mb-4 sm:mb-0">
                    <p class="text-sm text-gray-800 leading-relaxed">
                        ...
                        and result-oriented lead solution firm. <i
                            class="fi fi-sr-target-audience text-blue-500 text-3xl"></i>

                    </p>
                </div>
                <div
                    class="flex flex-col sm:flex-row items-center sm:space-x-6 text-gray-600 text-center sm:text-right w-full sm:w-auto">
        ...
        <footer class="bg-white shadow-lg w-full border-t">
            <div
                class="max-w-screen-xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center">
                <span class="text-sm text-gray-600">&copy; 1999-2024 System Resources Ltd.</span>
                <span class="text-sm text-gray-600">
                    Maintained by <a href="https://srl.com.bd/" target="_blank"
        ...
        <!-- Go to Top Button -->
        <button id="goToTop"
            class="fixed  bottom-4 right-4 bg-blue-600 text-white p-3 rounded-lg shadow-lg hover:bg-blue-700 transition-transform transform hover:scale-105">
