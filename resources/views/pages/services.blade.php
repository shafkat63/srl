...
<div class="container mx-auto py-12 px-4">
    ...
    <p class="text-lg text-gray-700 text-center mb-12">
        SRL’s primary objective is to provide value to its customers by delivering appropriate solutions that meet their
        specific needs.
    </p>
    ...
    <div class="relative">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            <!-- Service Card 1 -->
            <div id="service-1"
                class="bg-white p-6 rounded-lg shadow-lg border border-gray-200 transition-transform duration-500 transform hover:scale-150 hover:shadow-2xl hover:relative hover:z-10 flex flex-col items-center text-center">
                ...
                <p class="text-gray-600 mb-4">
                    SRL has a large number of analysts, solution architects, coders, testers, data conversion experts,
                    quality assurance experts, trainers, implementers, and project managers who are eligible to provide
                    you with the best-customized software development solution...
                </p>
            </div>
            ...
            <div id="service-2"
                ...
                <p class="text-gray-600 mb-4">
                    In recent years mobile apps have become the most popular platform which runs on Mobile. The demand
                    for mobile apps is increasing day by day. We have a great team to provide you consultancy and
                    develop mobile apps for software and e-commerce.
                </p>
            </div>
            ...
            <div id="service-3"
                ...
                <p class="text-gray-600 mb-4">
                    We, at System Resources Ltd. (SRL) can develop SEO-friendly and secured eCommerce sites using strong
                    frameworks of PHP, such as CodeIgniter, Laravel, Yii Framework, ASP .NET, C#, etc. SRL is one of the
                    top eCommerce developer companies in Bangladesh.
                </p>
            </div>
            ...
            <div id="service-4"
                ...
                <p class="text-gray-600 mb-4">
                    Experience and professionalism of the core team have positioned System Resources Ltd. as a trusted
                    and result-oriented service provider to its clients.
                </p>
            </div>
            ...
            <div id="service-5"
                ...
                <p class="text-gray-600 mb-4">
                    For smooth implementation and continuity of IT products, SRL performs appropriate assessments on IT
                    training needs for the human resources of user organizations and provides need-based IT training to
            ...
            <div id="service-6"
                ...
                <p class="text-gray-600 mb-4">
                    For smooth implementation and continuity of IT products, hardware maintenance and support are
                    essential. We provide hardware maintenance and support for our valuable clients.
                </p>
            </div>
            ...
            <div id="service-7"
                ...
                <p class="text-gray-600 mb-4">
                    Network infrastructure is at the center of business innovation. Users require fast, reliable, and
                    secure network infrastructure to collaborate, build, and grow. We provide networking solutions to
                    meet these needs.
                </p>
            </div>
            ...
            <div id="service-8"
                ...
                <p class="text-gray-600 mb-4">
                    Yes, your website has to woo and charm. It’s got to be authentic to your brand and attractive to
                    your audience. It’s got to be intuitive, mobile-ready, responsive, content-rich, SEO friendly, etc.
                    Our collaborative approach fosters creative thinking that delivers results.
                </p>
            </div>
        </div>
    </div>
